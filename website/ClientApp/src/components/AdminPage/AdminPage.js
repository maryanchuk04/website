                ...
                {state === 1 ? (
                  student.map((s, index) => (
                    <div className="qwert">
                      ...
                      />
                      <button onClick={(i) => doneNumeration(i, one, s.id)}>
                        Зберегти
                      </button>
                    </div>
                  ))
                ...
                {state === 2 ? (
                  speciality.map((s, index) => (
                    <div className="qwert">
                      ...
                      />
                      <button onClick={(i) => doneNumeration(i, two, s.id)}>
                        Зберегти
                      </button>
                    </div>
                  ))
                ...
                {state === 4 ? (
                  employers.map((s, index) => (
                    <div className="qwert">
                      ...
                      />
                      <button onClick={(i) => doneNumeration(i, three, s.id)}>
                        Зберегти
                      </button>
                    </div>
                  ))
                ...
                {state === 5 ? (
                  activies.map((a, index) => (
                    <div className="qwert">
                      ...
                      />
                      <button onClick={(i) => doneNumeration(i, four, a.id)}>
                        Зберегти
                      </button>
                    </div>
                  ))
                ...
                {state === 6 ? (
                  history.map((h, index) => (
                    <div className="qwert">
                      ...
                      <button onClick={(i) => doneNumeration(i, five, h.id)}>
                        Зберегти
                      </button>
                    </div>
                  ))
